...
$RepoUrlSsh = "git@github.com:AgentFlowX/agentflow-runtime.git"
$RepoUrlHttps = "https://github.com/AgentFlowX/agentflow-runtime.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/AgentFlowX/agentflow-runtime/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/AgentFlowX/agentflow-runtime/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/AgentFlowX/agentflow-runtime/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
