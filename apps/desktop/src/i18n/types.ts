...
export type Locale = 'en' | 'ru' | 'zh' | 'zh-hant' | 'ja' | 'ar'
...
export interface Translations {
  ...
  // Optional so full locales (zh/zh-hant/ja/ar) that don't yet translate the
  // quick-entry overlay fall back to English; en + ru provide it.
  quickEntry?: {
    currentChat: string
    newSession: string
    ask: string
