      ...
      >
        <div style={{ alignItems: 'center', display: 'flex', gap: 10 }}>
          ...
          <input
            ...
            placeholder={state.connected ? translateNow('quickEntry.ask') : translateNow('quickEntry.notConnected')}
            ref={inputRef}
            spellCheck={false}
            style={{
              background: 'transparent',
        ...
        <div style={{ alignItems: 'center', display: 'flex', gap: 8 }}>
          ...
          <select
            ...
            value={state.target}
          >
            <option value={QUICK_TARGET_CURRENT}>{translateNow('quickEntry.currentChat')}</option>
            <option value={QUICK_TARGET_NEW}>{translateNow('quickEntry.newSession')}</option>
