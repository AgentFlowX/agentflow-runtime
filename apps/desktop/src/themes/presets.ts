...
// ── AgentFlow brand identity ──────────────────────────────────────────────
// Placeholder brand palette — swap these three seeds for the official
// AgentFlow hex values and the whole theme re-derives. Indigo-violet primary
// with a warm cream accent for dark mode (mirrors the nous seed pattern).
const AGENTFLOW_INDIGO = '#1491F7'
const AGENTFLOW_DEEP = '#08090D'
const AGENTFLOW_CREAM = '#EAF4FF'

const afTint = (pct: number) => `color-mix(in srgb, ${AGENTFLOW_INDIGO} ${pct}%, #FFFFFF)`
const afTintTransparent = (pct: number) => `color-mix(in srgb, ${AGENTFLOW_INDIGO} ${pct}%, transparent)`

/**
 * AgentFlow — the default desktop brand identity. Neutral glass geometry with
 * AgentFlow indigo accents in light mode, and a deep-violet dark mode.
 */
export const agentflowTheme: DesktopTheme = {
  name: 'agentflow',
  label: 'AgentFlow',
  description: 'AgentFlow indigo on glass neutrals',
  colors: {
    background: '#F8F7FF',
    foreground: '#17151A',
    card: '#FFFFFF',
    ...
    popover: '#FFFFFF',
    popoverForeground: '#17151A',
    primary: AGENTFLOW_INDIGO,
    primaryForeground: '#FCFCFF',
    secondary: afTint(7),
    secondaryForeground: '#282433',
    accent: afTint(10),
    accentForeground: '#221E30',
    border: afTintTransparent(22),
    input: afTintTransparent(30),
    ring: AGENTFLOW_INDIGO,
    midground: AGENTFLOW_INDIGO,
    composerRing: AGENTFLOW_INDIGO,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F4F2FF',
    sidebarBorder: afTintTransparent(18),
    userBubble: afTint(6),
    userBubbleBorder: afTintTransparent(24)
  },
  darkColors: {
    background: AGENTFLOW_DEEP,
    foreground: AGENTFLOW_CREAM,
    card: '#101420',
    cardForeground: AGENTFLOW_CREAM,
    muted: '#151B2B',
    mutedForeground: '#9DB4D6',
    popover: '#101420',
    popoverForeground: AGENTFLOW_CREAM,
    primary: AGENTFLOW_INDIGO,
    primaryForeground: '#04070D',
    secondary: '#18202F',
    secondaryForeground: '#DCE8FA',
    accent: AGENTFLOW_INDIGO,
    accentForeground: '#EAF4FF',
    border: '#243247',
    input: '#0B0F18',
    ring: AGENTFLOW_INDIGO,
    midground: AGENTFLOW_INDIGO,
    ...
    sidebarBorder: '#1B2534',
    userBubble: '#14203A',
    userBubbleBorder: '#26456F'
  },
  typography: {
    fontSans: SYSTEM_SANS,
    fontMono: SYSTEM_MONO
...
export const DEFAULT_SKIN_NAME = 'agentflow'
