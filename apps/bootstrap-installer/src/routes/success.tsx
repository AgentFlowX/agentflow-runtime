  ...
  return (
    <div className="hermes-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>AgentFlow готов</span>
          </span>
          <span aria-hidden="true">AgentFlow готов</span>
        </p>

        <p className="m-0 text-center text-base leading-normal tracking-tight text-muted-foreground">
          Можно запустить отсюда или в любой момент из терминала командой{' '}
      ...
      <HackeryButton
        disabled={launching}
        label={launching ? 'Запуск' : 'Запустить'}
        loading={launching}
